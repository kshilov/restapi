...
public class RestTest {
  ...
  public static void reset() {
    ...
    try {
      ...
      session.createQuery("delete from LeadStat").executeUpdate();
      ...
      session.createQuery("delete from Placement").executeUpdate();
      session.createSQLQuery("delete from site").executeUpdate();
      ...
      session.createQuery("delete from Tariff").executeUpdate();
