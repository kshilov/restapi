...
public class OfferStatsResource {
  ...
  public OverallOfferStatsList allOfferStats(
    ...
    Pair<List<OverallOfferStats>, Long> p
        = stats.allOfferStats(granted, new DateTime(from), new DateTime(to), offset, limit);
  ...
  public OverallOfferStatsList offersByAffiliateStats(
    ...
    OverallOfferStatsList list = new OverallOfferStatsList();
    Pair<List<OverallOfferStats>, Long> p
        = stats.offerStatsByAffiliate(affId, new DateTime(from), new DateTime(to), offset, limit);
    list.stats.addAll(p.fst);
    list.count = p.snd;
    return list;
  }
  ...
  public OverallOfferStatsList offersByAdvertizerStats(
    ...
    OverallOfferStatsList list = new OverallOfferStatsList();
    Pair<List<OverallOfferStats>, Long> p
        = stats.offerStatsByAdvertiser(advId, new DateTime(from), new DateTime(to), offset, limit);
    list.stats.addAll(p.fst);
    list.count = p.snd;
    return list;
  }
  ...
  public OverallOfferStatsList allAffiliateStats(
    ...
    if (to == null) to = DateTimeUtils.currentTimeMillis();
    OverallOfferStatsList list = new OverallOfferStatsList();
    Pair<List<OverallOfferStats>, Long> p = stats.affStats(new DateTime(from), new DateTime(to), offset, limit);
    list.stats.addAll(p.fst);
    list.count = p.snd;
    return list;
  }
